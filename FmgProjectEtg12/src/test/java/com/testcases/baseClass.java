...
public class baseClass {
	...
	protected static String prviousEmail = "";
	protected static String email = "";
	protected static String emailEdited = "";
	
	protected static String prviousAddress = "";
	protected static String Address = "";
	protected static String AddressEdited = "";
	
	protected static String prviousShippingMethod = "";
	protected static String shippingMethodtitle = "";
	protected static String shippingMethodEdited = "";
